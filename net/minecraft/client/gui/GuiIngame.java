...
import net.minecraft.client.util.Config;
...
public class GuiIngame extends Gui
{
    ...
    public static boolean isTextInvi;
    ...
    public ExoniaHUD hud1 = new ExoniaHUD(this);
     /**
     * 
     * @author Chaos90
     * All rights reserved, any uses, sharing or selling of theses
     * code sample without any permissions will
     * have problems with the government. 
     *
     */
    
    public void showtoggleenabled(EntityPlayerSP sp, FontRenderer var8)
	{
		...
		if(sp.tsprintenabled){
			String tsa= "§aToggleSprint";
			var8.drawString(tsa, var6 - var8.getStringWidth(tsa)-10, var7-20, 50);
		}else{
			String tsd= "§cToggleSprint";
			var8.drawString(tsd, var6 - var8.getStringWidth(tsd)-10, var7-20, 50);
		}
		
		if(sp.tsneakenabled){
			String tsa= "§aToggleSneak";
			var8.drawString(tsa, var6 - var8.getStringWidth(tsa)-10, var7-10, 50);
		}else{
			String tsd= "§cToggleSneak";
			var8.drawString(tsd, var6 - var8.getStringWidth(tsd)-10, var7-10, 50);
		}
    ...
    private void showHUD(FontRenderer var8)
    {
      ...
      if (!this.mc.gameSettings.showDebugInfo)
      {
        if (casque != null)
        {
        int pourcentageCasque = (int)((float)(casque.getMaxDamage() - casque.getItemDamageForDisplay()) / (float)(casque.getMaxDamage()) * 100);
        int levels[] = {70, 50, 30, 10, 0};
  		int c = 0;
  		String[] couleur = {"\u00a72", "\u00a7a" ,"\u00a76" , "\u00a7c", "\u00a74"};
  		for(c = 0; c > levels.length; ++c)
  		{
  			if(pourcentageCasque > levels[c])
  				break;
  		}
          int var6 = this.mc.thePlayer.inventory.armorItemInSlot(3).getMaxDamage() - this.mc.thePlayer.inventory.armorItemInSlot(3).getItemDamageForDisplay();
          String thePotion = "" + var6;
          String thePourcent = couleur[c] + "" + pourcentageCasque + "%";
          if (Config.get("hud.armor").equals("ON")){
        	  var8.drawString(thePourcent, 20, 7, 16777215);
          } else
          var8.drawString(thePotion, 20, 7, 16777215);
          itemRenderer.renderItemIntoGUI(var8, this.mc.getTextureManager(), casque, 2, 2 + 18 * j);
          j++;
          GL11.glDisable(GL11.GL_LIGHTING);
        }
        if (plastron != null)
        {
    		int pourcentagePlastron = (int)((float)(plastron.getMaxDamage() - plastron.getItemDamageForDisplay()) / (float)(plastron.getMaxDamage()) * 100);
            int levels[] = {70, 50, 30, 10, 0};
      		int c = 0;
      		String[] couleur = {"\u00a72", "\u00a7a" ,"\u00a76" , "\u00a7c", "\u00a74"};
      		for(c = 0; c > levels.length; ++c)
      		{
      			if(pourcentagePlastron > levels[c])
      				break;
      		}
          int var6 = this.mc.thePlayer.inventory.armorItemInSlot(2).getMaxDamage() - this.mc.thePlayer.inventory.armorItemInSlot(2).getItemDamageForDisplay();
          String thePotion = "" + var6;
          String thePourcent = couleur[c] + "" + pourcentagePlastron + "%";
          if (Config.get("hud.armor").equals("ON")){
        	  var8.drawString(thePourcent, 20, 7 + 18 * j, 16777215);
          } else
          var8.drawString(thePotion, 20, 7 + 18 * j, 16777215);
          itemRenderer.renderItemIntoGUI(var8, this.mc.getTextureManager(), plastron, 2, 2 + 18 * j);
          j++;
          GL11.glDisable(GL11.GL_LIGHTING);
        }
        if (pantalon != null)
        {
    		int pourcentagePantalon = (int)((float)(pantalon.getMaxDamage() - pantalon.getItemDamageForDisplay()) / (float)(pantalon.getMaxDamage()) * 100);
            int levels[] = {70, 50, 30, 10, 0};
      		int c = 0;
      		String[] couleur = {"\u00a72", "\u00a7a" ,"\u00a76" , "\u00a7c", "\u00a74"};
      		for(c = 0; c > levels.length; ++c)
      		{
      			if(pourcentagePantalon > levels[c])
      				break;
      		}
          int var6 = this.mc.thePlayer.inventory.armorItemInSlot(1).getMaxDamage() - this.mc.thePlayer.inventory.armorItemInSlot(1).getItemDamageForDisplay();
          String thePotion = "" + var6;
          String thePourcent = couleur[c] + "" + pourcentagePantalon + "%";
          if (Config.get("hud.armor").equals("ON")){
        	  var8.drawString(thePourcent, 20, 7 + 18 * j, 16777215);
          } else
    	  var8.drawString(thePotion, 20, 7 + 18 * j, 16777215);
          itemRenderer.renderItemIntoGUI(var8, this.mc.getTextureManager(), pantalon, 2, 2 + 18 * j);
          j++;
          GL11.glDisable(GL11.GL_LIGHTING);
        }
        if (bottes != null)
        {
    		int pourcentageBottes = (int)((float)(bottes.getMaxDamage() - bottes.getItemDamageForDisplay()) / (float)(bottes.getMaxDamage()) * 100);
            int levels[] = {70, 50, 30, 10, 0};
      		int c = 0;
      		String[] couleur = {"\u00a72", "\u00a7a" ,"\u00a76" , "\u00a7c", "\u00a74"};
      		for(c = 0; c > levels.length; ++c)
      		{
      			if(pourcentageBottes > levels[c])
      				break;
      		}
          int var6 = this.mc.thePlayer.inventory.armorItemInSlot(0).getMaxDamage() - this.mc.thePlayer.inventory.armorItemInSlot(0).getItemDamageForDisplay();
          String thePotion = "" + var6;
          String thePourcent = couleur[c] + "" + pourcentageBottes + "%";
          if (Config.get("hud.armor").equals("ON")){
        	  var8.drawString(thePourcent, 20, 7 + 18 * j, 16777215);
          } else
          var8.drawString(thePotion, 20, 7 + 18 * j, 16777215);
          itemRenderer.renderItemIntoGUI(var8, this.mc.getTextureManager(), bottes, 2, 2 + 18 * j);
          j++;
          GL11.glDisable(GL11.GL_LIGHTING);
        }
        if ((main != null) && (((main.getItem() instanceof ItemSword)) || ((main.getItem() instanceof ItemBow)) || ((main.getItem() instanceof ItemTool)) || ((main.getItem() instanceof ItemFlintAndSteel)) || ((main.getItem() instanceof ItemShears)) || ((main.getItem() instanceof ItemFishingRod))))
        {
    		int pourcentageMain = (int)((float)(main.getMaxDamage() - main.getItemDamageForDisplay()) / (float)(main.getMaxDamage()) * 100);
            int levels[] = {70, 50, 30, 10, 0};
      		int c = 0;
      		String[] couleur = {"\u00a72", "\u00a7a" ,"\u00a76" , "\u00a7c", "\u00a74"};
      		for(c = 0; c > levels.length; ++c)
      		{
      			if(pourcentageMain > levels[c])
      				break;
      		}
          int var6 = this.mc.thePlayer.inventory.getCurrentItem().getMaxDamage() - this.mc.thePlayer.inventory.getCurrentItem().getItemDamageForDisplay();
          String thePotion = "" + var6;
          String thePourcent = couleur[c] + "" + pourcentageMain + "%";
          if (Config.get("hud.armor").equals("ON")){
        	  var8.drawString(thePourcent, 20, 7 + 18 * j, 16777215);
          } else
          var8.drawString(thePotion, 20, 7 + 18 * j, 16777215);
          itemRenderer.renderItemIntoGUI(var8, this.mc.getTextureManager(), main, 2, 2 + 18 * j);
          j++;
          GL11.glDisable(GL11.GL_LIGHTING);
        }
        if (!this.mc.thePlayer.getActivePotionEffects().isEmpty()) {
          for (Iterator var12 = this.mc.thePlayer.getActivePotionEffects().iterator(); var12.hasNext(); j++)
          {
            ...
            if (var14.hasStatusIcon())
            {
              ...
              drawTexturedModalRect(1, 2 + 18 * j, 0 + stringPotion % 8 * 18, 198 + stringPotion / 8 * 18, 18, 18);
            }
    ...
    public void renderGameOverlay(float p_73830_1_, boolean p_73830_2_, int p_73830_3_, int p_73830_4_)
    {
        ...
        if (!this.mc.playerController.enableEverythingIsScrewedUpMode())
        {
        	if (displayedCenterMessage != null)
        	{
        	 ...
        	 this.mc.fontRenderer.drawString(displayedCenterMessage, (var6 - this.mc.fontRenderer.getStringWidth(displayedCenterMessage)) / 2, var7 / 2 - 15, color);
        	}
            GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
            ...
            for (var11 = 0; var11 < 9; ++var11)
            {
                ...
                var13 = var7 - 16 - 3;
                this.renderInventorySlot(var11, var12, var13, p_73830_4_);
            }
            ...
            if (this.mc.gameSettings.showDebugInfo)
            {
                ...
                GL11.glPushMatrix();
                var8.drawStringWithShadow("§5Orizia" +  " §8(" + this.mc.debug + ")", 2, 2, 16777215);
                ...
                this.drawString(var8, String.format("§5X §7>> §5%.5f (%d)", new Object[] {Double.valueOf(this.mc.thePlayer.posX), Integer.valueOf(var22), Integer.valueOf(var22 >> 4), Integer.valueOf(var22 & 15)}), 2, 15, 14737632);
                this.drawString(var8, String.format("§5Y §7>> §5%.3f", new Object[] {Double.valueOf(this.mc.thePlayer.boundingBox.minY), Double.valueOf(this.mc.thePlayer.posY)}), 2, 30, 14737632);
                this.drawString(var8, String.format("§5Z §7>> §5%.5f (%d)", new Object[] {Double.valueOf(this.mc.thePlayer.posZ), Integer.valueOf(var24), Integer.valueOf(var24 >> 4), Integer.valueOf(var24 & 15)}), 2, 45, 14737632);
                int var25 = MathHelper.floor_double((double)(this.mc.thePlayer.rotationYaw * 4.0F / 360.0F) + 0.5D) & 3;
                this.drawString(var8, "§5Directions §7>> §5" + Direction.directions[var25], 2, 60, 14737632);
                GL11.glPopMatrix();
                this.mc.mcProfiler.endSection();
            }
