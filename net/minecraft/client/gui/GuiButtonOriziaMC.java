...
public class GuiButtonOriziaMC extends GuiButton

{
    private static int F = 0;
    public static final ResourceLocation button = new ResourceLocation("textures/gui/rejoindre.png");
    ...
    String co = gui.readFile("https://minecraft-api.com/api/ping/playeronline.php?ip=164.132.222.44&port=25565");
    

    public GuiButtonOriziaMC(int paramInt1, int paramInt2, int paramInt3, String paramString)
    ...
    public GuiButtonOriziaMC(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, String paramString)
