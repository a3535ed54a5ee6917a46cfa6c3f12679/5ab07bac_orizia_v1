...
public class TileEntityPyriteChestRenderer extends TileEntitySpecialRenderer
{
    private static final ResourceLocation field_147504_k = new ResourceLocation("textures/entity/chest/pyrite.png");
    private ModelChest field_147510_h = new ModelChest();

    public TileEntityPyriteChestRenderer() { }

    public void renderTileEntityAt(TileEntityPyriteChest p_147502_1_, double p_147502_2_, double p_147502_4_, double p_147502_6_, float p_147502_8_)
    {
        int var9;
        ...
        if (p_147502_1_.field_145992_i == null && p_147502_1_.field_145991_k == null)
        {
            ...
            this.bindTexture(field_147504_k);
    ...
    {
        this.renderTileEntityAt((TileEntityPyriteChest)p_147500_1_, p_147500_2_, p_147500_4_, p_147500_6_, p_147500_8_);
    }
}