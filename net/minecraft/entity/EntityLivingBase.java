...
public abstract class EntityLivingBase extends Entity
{
 ...
 // Alkazia - milk Potion 
    ...
    public void clearActiveNegativePotions()
    {
        Iterator var1 = this.activePotionsMap.keySet().iterator();
        ...
        while (var1.hasNext())
        {
            Integer var2 = (Integer)var1.next();
            PotionEffect var3 = (PotionEffect)this.activePotionsMap.get(var2);
            if (!this.worldObj.isClient && (var3.getEffectName() == "potion.poison" || var3.getEffectName() == "potion.weakness" || var3.getEffectName() == "potion.moveSlowdown"))
            {
                var1.remove();
                this.onFinishedPotionEffect(var3);
            }
    ...
    public boolean isOnIronLadder()
    {
        ...
        // Alkazia - Iron Ladder setup
        return var4 == Blocks.ladder_pyrite;
    }
    ...
    public boolean hasFallEffect() {
        ...
        while (var1.hasNext())
        {
            Integer var2 = (Integer)var1.next();
            PotionEffect var3 = (PotionEffect)this.activePotionsMap.get(var2);
            if (this.worldObj.isClient && var3.getEffectName() == "potion.fall")
            {
            	return true;
            }
        }
