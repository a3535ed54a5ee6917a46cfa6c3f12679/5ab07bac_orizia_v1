...
public class Items
{
    ...
    public static final Item pyrite = (Item)Item.itemRegistry.getObject("pyrite");
    public static final Item zironite = (Item)Item.itemRegistry.getObject("zironite");
    public static final Item uranium = (Item)Item.itemRegistry.getObject("uranium");
    public static final Item orizium = (Item)Item.itemRegistry.getObject("orizium");
    public static final Item pyrite_cookie = (Item)Item.itemRegistry.getObject("pyrite_cookie");
    public static final Item zironite_cookie = (Item)Item.itemRegistry.getObject("zironite_cookie");
    public static final Item fire_cookie = (Item)Item.itemRegistry.getObject("fire_cookie");
    public static final Item golden_bread = (Item)Item.itemRegistry.getObject("golden_bread");
    public static final Item orbe_hast = (Item)Item.itemRegistry.getObject("orbe_hast");
    public static final Item katana = (Item)Item.itemRegistry.getObject("katana");
    public static final Item heal_sceptre = (Item)Item.itemRegistry.getObject("heal_sceptre");
    public static final Item clef_pyrite = (Item)Item.itemRegistry.getObject("clef_pyrite");
    public static final Item clef_zironite = (Item)Item.itemRegistry.getObject("clef_zironite");
    public static final Item clef_uranium = (Item)Item.itemRegistry.getObject("clef_uranium");
    public static final Item fortmultiaxe = (Item)Item.itemRegistry.getObject("fortmultiaxe");
    
    public static final ItemArmor pyrite_helmet = (ItemArmor)Item.itemRegistry.getObject("pyrite_helmet");
    public static final ItemArmor pyrite_chestplate = (ItemArmor)Item.itemRegistry.getObject("pyrite_chestplate");
    public static final ItemArmor pyrite_leggings = (ItemArmor)Item.itemRegistry.getObject("pyrite_leggings");
    public static final ItemArmor pyrite_boots = (ItemArmor)Item.itemRegistry.getObject("pyrite_boots");
    
    public static final ItemArmor zironite_helmet = (ItemArmor)Item.itemRegistry.getObject("zironite_helmet");
    public static final ItemArmor zironite_chestplate = (ItemArmor)Item.itemRegistry.getObject("zironite_chestplate");
    public static final ItemArmor zironite_leggings = (ItemArmor)Item.itemRegistry.getObject("zironite_leggings");
    public static final ItemArmor zironite_boots = (ItemArmor)Item.itemRegistry.getObject("zironite_boots");
    
    public static final ItemArmor uranium_helmet = (ItemArmor)Item.itemRegistry.getObject("uranium_helmet");
    public static final ItemArmor uranium_chestplate = (ItemArmor)Item.itemRegistry.getObject("uranium_chestplate");
    public static final ItemArmor uranium_leggings = (ItemArmor)Item.itemRegistry.getObject("uranium_leggings");
    public static final ItemArmor uranium_boots = (ItemArmor)Item.itemRegistry.getObject("uranium_boots");
    
    public static final ItemArmor orizium_helmet = (ItemArmor)Item.itemRegistry.getObject("orizium_helmet");
    public static final ItemArmor orizium_chestplate = (ItemArmor)Item.itemRegistry.getObject("orizium_chestplate");
    public static final ItemArmor orizium_leggings = (ItemArmor)Item.itemRegistry.getObject("orizium_leggings");
    public static final ItemArmor orizium_boots = (ItemArmor)Item.itemRegistry.getObject("orizium_boots");
    
    public static final Item pyrite_sword = (Item)Item.itemRegistry.getObject("pyrite_sword");
    public static final Item pyrite_shovel = (Item)Item.itemRegistry.getObject("pyrite_shovel");
    public static final Item pyrite_pickaxe = (Item)Item.itemRegistry.getObject("pyrite_pickaxe");
    public static final Item pyrite_axe = (Item)Item.itemRegistry.getObject("pyrite_axe");
    public static final Item pyrite_hoe = (Item)Item.itemRegistry.getObject("pyrite_hoe");
    
    public static final Item zironite_sword = (Item)Item.itemRegistry.getObject("zironite_sword");
    public static final Item zironite_shovel = (Item)Item.itemRegistry.getObject("zironite_shovel");
    public static final Item zironite_pickaxe = (Item)Item.itemRegistry.getObject("zironite_pickaxe");
    public static final Item zironite_axe = (Item)Item.itemRegistry.getObject("zironite_axe");
    public static final Item zironite_hoe = (Item)Item.itemRegistry.getObject("zironite_hoe");
    
    public static final Item uranium_sword = (Item)Item.itemRegistry.getObject("uranium_sword");
    public static final Item uranium_shovel = (Item)Item.itemRegistry.getObject("uranium_shovel");
    public static final Item uranium_pickaxe = (Item)Item.itemRegistry.getObject("uranium_pickaxe");
    public static final Item uranium_axe = (Item)Item.itemRegistry.getObject("uranium_axe");
    public static final Item uranium_hoe = (Item)Item.itemRegistry.getObject("uranium_hoe");
    
    public static final Item orizium_sword = (Item)Item.itemRegistry.getObject("orizium_sword");
    public static final Item orizium_shovel = (Item)Item.itemRegistry.getObject("orizium_shovel");
    public static final Item orizium_pickaxe = (Item)Item.itemRegistry.getObject("orizium_pickaxe");
    public static final Item orizium_axe = (Item)Item.itemRegistry.getObject("orizium_axe");
    public static final Item orizium_hoe = (Item)Item.itemRegistry.getObject("orizium_hoe");
    
    public static final ItemBow arc_orizium = (ItemBow)Item.itemRegistry.getObject("arc_orizium");
    public static final ItemBow arc_pyrite = (ItemBow)Item.itemRegistry.getObject("arc_pyrite");
    public static final ItemBow arc_zironite = (ItemBow)Item.itemRegistry.getObject("arc_zironite");
    public static final ItemBow arc_uranium = (ItemBow)Item.itemRegistry.getObject("arc_uranium");

    public static final Item orizium_stick = (Item)Item.itemRegistry.getObject("orizium_stick");
