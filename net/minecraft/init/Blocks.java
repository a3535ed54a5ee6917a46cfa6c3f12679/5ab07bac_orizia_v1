...
public class Blocks
{
    ...
    public static final Block pyrite_ore = (Block)Block.blockRegistry.getObject("pyrite_ore");
    public static final Block pyrite_block = (Block)Block.blockRegistry.getObject("pyrite_block");
    public static final Block zironite_ore = (Block)Block.blockRegistry.getObject("zironite_ore");
    public static final Block zironite_block = (Block)Block.blockRegistry.getObject("zironite_block");
    public static final Block uranium_ore = (Block)Block.blockRegistry.getObject("uranium_ore");
    public static final Block uranium_block = (Block)Block.blockRegistry.getObject("uranium_block");
    public static final Block orizium_ore = (Block)Block.blockRegistry.getObject("orizium_ore");
    public static final Block orizium_block = (Block)Block.blockRegistry.getObject("orizium_block");
    public static final Block crystal_block = (Block)Block.blockRegistry.getObject("crystal_block");
    public static final Block invisible = (Block)Block.blockRegistry.getObject("invisible");
    public static final Block invisible_glowstone = (Block)Block.blockRegistry.getObject("invisible_glowstone");
    public static final Block ladder_pyrite = (Block)Block.blockRegistry.getObject("ladder_pyrite");  
