...
public class Block
{
    ...
    public static void registerBlocks()
    {
        ...
        blockRegistry.addObject(200, "pyrite_ore", (new BlockOre()).setHardness(3.0F).setResistance(5.0F).setStepSound(soundTypePiston).setBlockName("pyrite_ore").setBlockTextureName("pyrite_ore"));
        blockRegistry.addObject(204, "pyrite_block", (new BlockCompressed(MapColor.field_151648_G)).setHardness(5.0F).setResistance(10.0F).setStepSound(soundTypeMetal).setBlockName("pyrite_block").setBlockTextureName("pyrite_block"));
        
        blockRegistry.addObject(201, "zironite_ore", (new BlockOre()).setHardness(3.0F).setResistance(5.0F).setStepSound(soundTypePiston).setBlockName("zironite_ore").setBlockTextureName("zironite_ore"));
        blockRegistry.addObject(205, "zironite_block", (new BlockCompressed(MapColor.field_151648_G)).setHardness(5.0F).setResistance(10.0F).setStepSound(soundTypeMetal).setBlockName("zironite_block").setBlockTextureName("zironite_block"));
       
        blockRegistry.addObject(202, "uranium_ore", (new BlockOre()).setHardness(3.0F).setResistance(5.0F).setStepSound(soundTypePiston).setBlockName("uranium_ore").setBlockTextureName("uranium_ore"));
        blockRegistry.addObject(206, "uranium_block", (new BlockCompressed(MapColor.field_151648_G)).setHardness(5.0F).setResistance(10.0F).setStepSound(soundTypeMetal).setBlockName("uranium_block").setBlockTextureName("uranium_block"));
       
        blockRegistry.addObject(203, "orizium_ore", (new BlockOre()).setHardness(3.0F).setResistance(5.0F).setStepSound(soundTypePiston).setBlockName("orizium_ore").setBlockTextureName("orizium_ore"));
        blockRegistry.addObject(207, "orizium_block", (new BlockCompressed(MapColor.field_151648_G)).setHardness(5.0F).setResistance(10.0F).setStepSound(soundTypeMetal).setBlockName("orizium_block").setBlockTextureName("orizium_block"));	
   
        blockRegistry.addObject(214, "pyrite_ladder", (new BlockLadder()).setHardness(0.4F).setStepSound(soundTypeLadder).setBlockName("pyrite_ladder").setBlockTextureName("pyrite_ladder"));

        blockRegistry.addObject(220, "crystal_block", (new BlockObsidian()).setHardness(50.0F).setResistance(2000.0F).setStepSound(soundTypePiston).setBlockName("crystal_block").setBlockTextureName("crystal_block"));
     
        blockRegistry.addObject(213, "invisible", (new Block(Material.rock)).setBlockUnbreakable().setResistance(6000000.0F).setStepSound(soundTypePiston).setBlockName("invisible").disableStats().setCreativeTab(CreativeTabs.tabBlock).setBlockTextureName("invisible"));
     
        blockRegistry.addObject(212, "invisible_glowstone", (new BlockGlowstone(Material.glass)).setHardness(0.3F).setStepSound(soundTypeGlass).setLightLevel(1.0F).setBlockName("invisible_glowstone").setBlockTextureName("invisible_glowstone"));
