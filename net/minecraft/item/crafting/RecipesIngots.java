...
public class RecipesIngots
{
    ...
    {
        this.recipeItems = new Object[][] {{Blocks.gold_block, new ItemStack(Items.gold_ingot, 9)}, {Blocks.iron_block, new ItemStack(Items.iron_ingot, 9)}, {Blocks.diamond_block, new ItemStack(Items.diamond, 9)}, {Blocks.emerald_block, new ItemStack(Items.emerald, 9)}, {Blocks.pyrite_block, new ItemStack(Items.pyrite, 9)}, {Blocks.zironite_block, new ItemStack(Items.zironite, 9)}, {Blocks.uranium_block, new ItemStack(Items.uranium, 9)}, {Blocks.orizium_block, new ItemStack(Items.orizium, 9)}, {Blocks.lapis_block, new ItemStack(Items.dye, 9, 4)}, {Blocks.redstone_block, new ItemStack(Items.redstone, 9)}, {Blocks.coal_block, new ItemStack(Items.coal, 9, 0)}, {Blocks.hay_block, new ItemStack(Items.wheat, 9)}};
    }
