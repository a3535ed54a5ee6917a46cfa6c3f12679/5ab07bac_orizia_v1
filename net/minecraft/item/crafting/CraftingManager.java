...
public class CraftingManager
{
    ...
    private CraftingManager()
    {
        ...
        this.addRecipe(new ItemStack(Items.katana, 1), new Object[] {" X ", " X ", " S ", 'X', Blocks.orizium_block, 'S', Items.orizium_stick});
        this.addRecipe(new ItemStack(Items.orizium_stick, 1), new Object[] {"   ", " X ", " X ", 'X', Items.orizium});
        this.addRecipe(new ItemStack(Items.heal_sceptre, 1), new Object[] {"XXX", " X ", " X ", 'X', Items.uranium});
