...
public class ItemArmor extends Item
{
    ...
    {
    	if((p_82789_1_.getItem() == Items.orizium_helmet || p_82789_1_.getItem() == Items.orizium_chestplate || p_82789_1_.getItem() == Items.orizium_leggings || p_82789_1_.getItem() == Items.orizium_boots ||  p_82789_1_.getItem() == Items.orizium_sword ||  p_82789_1_.getItem() == Items.orizium_hoe ||  p_82789_1_.getItem() == Items.orizium))
    	{
            return true;
    }
    		if((p_82789_1_.getItem() == Items.pyrite_helmet || p_82789_1_.getItem() == Items.pyrite_chestplate || p_82789_1_.getItem() == Items.pyrite_leggings || p_82789_1_.getItem() == Items.pyrite_boots ||  p_82789_1_.getItem() == Items.pyrite))
    		{
                return true;
        }
    			if((p_82789_1_.getItem() == Items.zironite_helmet || p_82789_1_.getItem() == Items.zironite_chestplate || p_82789_1_.getItem() == Items.zironite_leggings || p_82789_1_.getItem() == Items.zironite_boots ||  p_82789_1_.getItem() == Items.zironite))
    			{
                    return true;
            }
    				if((p_82789_1_.getItem() == Items.uranium_helmet || p_82789_1_.getItem() == Items.uranium_chestplate || p_82789_1_.getItem() == Items.uranium_leggings || p_82789_1_.getItem() == Items.uranium_boots || p_82789_2_.getItem() == Items.uranium))
    ...
    public static enum ArmorMaterial
    {
        ...
        DIAMOND("DIAMOND", 4, 33, new int[]{2, 7, 6, 3}, 10),
        PYRITE("PYRITE", 5, 44, new int[]{3, 7, 6, 3}, 10),
        ZIRONITE("ZIRONITE", 6, 55, new int[]{3, 8, 7, 3}, 10),
        URANIUM("URANIUM", 7, 77, new int[]{4, 8, 7, 4}, 10),
        ORIZIUM("ORIZIUM", 8, 88, new int[]{4, 9, 7, 4}, 10);
        private int maxDamageFactor;
        private int[] damageReductionAmountArray;
        private int enchantability;

        private static final ItemArmor.ArmorMaterial[] $VALUES = new ItemArmor.ArmorMaterial[]{CLOTH, CHAIN, IRON, GOLD, DIAMOND, PYRITE, ZIRONITE, URANIUM, ORIZIUM};
