...
public class FireCookie extends ItemFood
{
    private static final String __OBFID = "CL_98000037";

    public FireCookie(int p_i45341_1_, float p_i45341_2_, boolean p_i45341_3_)
    {
    ...
    protected void onFoodEaten(ItemStack p_77849_1_, World p_77849_2_, EntityPlayer p_77849_3_)
    {
        ...
        {
            p_77849_3_.addPotionEffect(new PotionEffect(Potion.fireResistance.id, 7500, 1));
        }
