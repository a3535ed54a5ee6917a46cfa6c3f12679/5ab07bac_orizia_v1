...
public class PyriteCookie extends ItemFood
{
    private static final String __OBFID = "CL_90090037";

    public PyriteCookie(int p_i45341_1_, float p_i45341_2_, boolean p_i45341_3_)
    {
