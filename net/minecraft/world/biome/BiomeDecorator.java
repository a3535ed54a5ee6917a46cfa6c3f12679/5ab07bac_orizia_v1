...
public class BiomeDecorator
{
    ...
    protected WorldGenerator zironiteGen;
    protected WorldGenerator uraniumGen;
    protected WorldGenerator oriziumGen;
    ...
    public BiomeDecorator()
    {
        ...
        this.pyriteGen = new WorldGenMinable(Blocks.pyrite_ore, 7);
        this.zironiteGen = new WorldGenMinable(Blocks.zironite_ore, 6);
        this.uraniumGen = new WorldGenMinable(Blocks.uranium_ore, 4);
        this.oriziumGen = new WorldGenMinable(Blocks.orizium_ore, 3);
    ...
    protected void generateOres()
    {
        ...
        this.genStandardOre1(1, this.pyriteGen, 0, 16);
        this.genStandardOre1(1, this.zironiteGen, 0, 12);
        this.genStandardOre1(1, this.uraniumGen, 0, 9);
        this.genStandardOre1(1, this.oriziumGen, 0, 9);
    }
}
