...
import net.minecraft.block.BlockPyriteChest;
...
public class TileEntityPyriteChest extends TileEntity implements IInventory
{
    private ItemStack[] field_145985_p;
    public boolean field_145984_a;
    public TileEntityPyriteChest field_145992_i;
    public TileEntityPyriteChest field_145990_j;
    public TileEntityPyriteChest field_145991_k;
    public TileEntityPyriteChest field_145988_l;
    ...
    public TileEntityPyriteChest()
    {
    	field_145985_p = new ItemStack[54];
        this.field_145982_r = -1;
    }

    public TileEntityPyriteChest(int par1)
    {
    	field_145985_p = new ItemStack[54];
    ...
    private void func_145978_a(TileEntityPyriteChest p_145978_1_, int p_145978_2_)
    {
    ...
    private boolean func_145977_a(int p_145977_1_, int p_145977_2_, int p_145977_3_)
    {
        ...
        return var4 instanceof BlockPyriteChest && ((BlockPyriteChest)var4).field_149956_a == this.func_145980_j();
    }
    ...
    {
        if (this.getBlockType() instanceof BlockPyriteChest)
        {
            --this.field_145987_o;
            this.worldObj.func_147452_c(this.field_145851_c, this.field_145848_d, this.field_145849_e, this.getBlockType(), 1, this.field_145987_o);
            this.worldObj.notifyBlocksOfNeighborChange(this.field_145851_c, this.field_145848_d, this.field_145849_e, this.getBlockType());
    ...
    public int func_145980_j()
    {
        ...
        {
            if (this.worldObj == null || !(this.getBlockType() instanceof BlockPyriteChest))
            {
                return 0;
            }

            this.field_145982_r = ((BlockPyriteChest)this.getBlockType()).field_149956_a;
        }
